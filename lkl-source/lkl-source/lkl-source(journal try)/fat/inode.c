...
{
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_writepage\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
{
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_writepages\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
{
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_evict_inode\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
{
	struct msdos_sb_info *sbi = MSDOS_SB(sb);
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_put_super\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
static struct inode *fat_alloc_inode(struct super_block *sb)
{
	...
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_alloc_inode\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
static int fat_remount(struct super_block *sb, int *flags, char *data)
{
	...
	*flags |= SB_NODIRATIME | (sbi->options.isvfat ? 0 : SB_NOATIME);
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_remount\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
	sync_filesystem(sb);
...
static int fat_statfs(struct dentry *dentry, struct kstatfs *buf)
{
	...
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_statfs\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
static int fat_write_inode(struct inode *inode, struct writeback_control *wbc)
{
	...
	int err;
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_write_inode\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
static int fat_show_options(struct seq_file *m, struct dentry *root)
{
	...
	printk(KERN_INFO "SUPERBLOCK_FUNCTION:fat_show_options\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
