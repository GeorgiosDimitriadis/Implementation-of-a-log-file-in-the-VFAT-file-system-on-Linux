...
#include <linux/syscalls.h>//prosthiki to include
//#include <linux/stdio.h>//prosthiki to include
/*
...
struct msdos_sb_info {
	int fdiscriptor_journal;	//prosthiki file discripor gia klhseis systhmatos arxeiou
