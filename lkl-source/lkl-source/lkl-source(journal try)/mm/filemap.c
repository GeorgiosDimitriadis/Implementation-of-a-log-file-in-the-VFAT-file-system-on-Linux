...
{
	struct address_space *mapping = file->f_mapping;
	printk(KERN_INFO "FILES_FUNCTION:generic_file_mmap\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
ssize_t generic_file_write_iter(struct kiocb *iocb, struct iov_iter *from)
{
	...
	ssize_t ret;
	printk(KERN_INFO "FILES_FUNCTION:generic_file_write_iter\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
	inode_lock(inode);
