...
{
	printk(KERN_INFO "FILES_FUNCTION:fat_file_release\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
...
int fat_file_fsync(struct file *filp, loff_t start, loff_t end, int datasync)
{
	...
	int err;
	printk(KERN_INFO "FILES_FUNCTION:fat_file_fsync\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
			  ...
			  loff_t offset, loff_t len)
{
	...
	int err = 0;
	printk(KERN_INFO "FILES_FUNCTION:fat_fallocate\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
		...
		struct kstat *stat, u32 request_mask, unsigned int flags)
{
	...
	struct msdos_sb_info *sbi = MSDOS_SB(inode->i_sb);
	printk(KERN_INFO "FILES_FUNCTION:fat_getattr\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
		...
		struct iattr *attr)
{
	...
	int error;
	printk(KERN_INFO "FILES_FUNCTION:fat_setattr\n");//topothethsh printk gia na typwnei to onoma ths synarthshs
